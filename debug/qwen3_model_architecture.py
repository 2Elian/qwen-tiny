...
def build_model(args, device):
    ...
    if args.mode == "baseline":
        ...
        print("this is a qwen3-model debug mode")
...
if __name__ == "__main__":
    # please edit launch.json in debug
    # python -m debugpy --listen 5678 qwen3_model_architecture.py --mode baseline --steps 5 --hidden_size 128 --num_layers 2
    main()
